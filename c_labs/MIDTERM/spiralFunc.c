...
/*											*/
/* Basically the function "func" helps main function "fill"				*/
/* for each starting point like (0,0)(1,1)(2,2)...until (the center point of the matrix)*/
...
/*fill the four edges starting from the point with the value*/
void func(int m[][MAX_SIZE],int size,int point,int* value);
...
/*														*/
/****************************************************************************************************************/
void func(int m[ MAX_SIZE][ MAX_SIZE],int size,int point,int* value)
{
...
{
   int start_point,current_value=0;
   for(start_point=0;start_point<=(int)(size/2);start_point++)      // it will start from 0,0 and continue like 1,1 ;2,2   
       func(m,size,start_point, &current_value);		    //  repeats until the point equals to the center point of the matrix
